...
describe('different actions will return the desired state', () => {
    ...
    describe('MOVE_RIGHT', () => {
        test("with a state mock that can't move right", () => {
            ...
            const newState = reducer(state, moveRight())
    ...
    describe('MOVE_LEFT', () => {
        test("with a state mock that can't move left", () => {
            ...
            const newState = reducer(state, moveLeft())
            expect(newState.image).toStrictEqual(state.image)
        })
    ...
    describe('MOVE_UP', () => {
        test("with a state mock that can't move up", () => {
            ...
            const newState = reducer(state, moveUp())
            expect(newState.image).toStrictEqual(state.image)
        })
    ...
    describe('MOVE_DOWN', () => {
        test("with a state mock that can't move down", () => {
            ...
            const newState = reducer(state, moveDown())
            expect(newState.image).toStrictEqual(state.image)
        })
    ...
    describe('SCALE_UP', () => {
        test('scale up', () => {
            ...
            const newState = reducer(state, scaleUp())
    ...
    describe('SCALE_DOWN', () => {
        test("with a state mock that can't scale down", () => {
            ...
            const newState = reducer(state, scaleDown())
            expect(newState.image).toStrictEqual(state.image)
        })
    ...
    describe('UPLOAD_FILE', () => {
        test('file upload', () => {
            ...
            const newState = reducer(undefined, uploadFile(image))
    ...
    describe('ERROR_MESSAGE', () => {
        test('set error message', () => {
            ...
            const newState = reducer(state, setErrorMessage(err))
